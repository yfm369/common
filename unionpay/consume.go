...
func (up *UnionPay) FrontConsume(orderID string, amount string, returnURL, notifyURL string, extraParams map[string]string) (html string, err error) {
...
func (up *UnionPay) initFrontConsumeParams(orderID string, amount string, returnURL, notifyURL string, extraParams map[string]string) (params map[string]string) {
